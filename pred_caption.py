# -*- coding: utf-8 -*-
"""Predict Caption.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1mwkDBRarsOVg5H2j90vmQ6sJYqyJmtzW
"""
...
unique = pickle.load(open(path + 'unique.p', 'rb'))
...
def data_generator(batch_size = 32):
        ...
        df = pd.read_csv(path + 'flickr8k_training_dataset.txt', delimiter='\t')
        df = df.sample(frac=1)
        iter = df.iterrows()
        c = []
        imgs = []
